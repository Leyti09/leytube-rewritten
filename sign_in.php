...
<?php
	$__server->page_embeds->page_title = "LeyTube - Sign In";
		...
		<div id="page" class="">
			...
			<div id="content-container">
				...
				<div id="content" style="">
                    <h2>Sign In to LeyTube</h2>
                    <br>
					<div class="www-left">
						<b>Join the rockiest video-sharing community!</b><br>
						Sign up now to get full access with your LeyTube account: <br><br>
						<ul>
						...
						</ul><br><a href="/sign_up">Sign up now </a> to join the LeyTube community.<br>
<br><br>
					</div>
					<div class="www-right">
