...
Get <a href="//support.google.com/youtube/bin/answer.py?answer=1229982&amp;hl=en-US">help setting up HTML5 3D</a>, or change 3D viewing modes.
    ...
    <div class="html5-info-bar-buttons">
      ...
      <div class="html5-info-bar-logo hid">SubRock</div>
    </div>
...
C27.533,0.1,33.367,0,41.1,0h8.05c10.8,0,20.367,0.583,28.7,1.75C82.317,2.417,85.317,5.467,86.85,10.9z"/>
  ...
  <div class="html5-progress-tooltip hid">
    ...
    <button onclick=";return false;" title="Watch on SubRock" type="button" class="html5-watch-on-youtube-button html5-control-right html5-control-sep yt-uix-button yt-uix-button-player yt-uix-tooltip yt-uix-button-empty" tabindex="12"  role="button" aria-label="Watch on SubRock"><span class="yt-uix-button-icon-wrapper"><img class="yt-uix-button-icon yt-uix-button-icon-html5" src="//s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif" alt="Watch on SubRock"><span class="yt-valign-trick"></span></span></button>
