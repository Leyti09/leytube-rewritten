		...
		<div id="page" class="">
			...
			<div id="content-container">
				...
				<div id="content">
                    ...
                    <input id="video-link" style="width: 300px;" placeholder="Video Link" class="upload-input" type="text" value="https://leytube.serv00.net/watch?v=<?php echo $_video['rid']; ?>" name="title"><br><br>
                    <br>
                </div>
            </div>  
