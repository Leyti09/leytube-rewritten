...
Get <a href="//support.google.com/youtube/bin/answer.py?answer=1229982&amp;hl=en-US">help setting up HTML5 3D</a>, or change 3D viewing modes.
    ...
    <div class="html5-info-panel-content hid">
      ...
      <span class="enable-fancy-subscribe-button">
        <span class="yt-uix-button-context-light yt-uix-button-subscription-container"><button href="" onclick=";return false;" type="button" class="yt-subscription-button yt-subscription-button-js-default html5-subscribe-button yt-uix-button-dark  yt-uix-button yt-uix-button-subscription" data-subscription-feature="" data-sessionlink="ei=CKmu--HchLQCFZQSIQodaXiYtA%3D%3D" data-subscription-value="id" data-subscription-type="" role="button"><span class="yt-uix-button-icon-wrapper"><img class="yt-uix-button-icon yt-uix-button-icon-subscribe" src="//s.ytimg.com/yts/img/pixel-vfl3z5WfW.gif" alt=""><span class="yt-uix-button-valign"></span></span><span class="yt-uix-button-content">  <span class="subscribe-label">Subscribe</span>
  ...
  <span class="video-extras-likes-dislikes">
    ...
    .html5-overlay-button-background {
      fill: url(#html5-big-play-button-black);
    }
    .html5-video-player:hover .html5-overlay-button-background {
      fill: url(#html5-big-play-button-red);
    }
    </style>
